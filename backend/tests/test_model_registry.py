from app.config.model_registry import get_model, list_models, list_providers, resolve_model_info
...
def test_resolve_model_info_keeps_ollama_tag() -> None:
    model = resolve_model_info("llama3.2:latest")
    assert model is not None
